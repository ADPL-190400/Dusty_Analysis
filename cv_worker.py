...
MORPH_KERNEL        = 1     # [1–7]     kernel morphological open (xóa noise)
MORPH_CLOSE_KERNEL  = 1     # [1–11]    kernel morphological close (nối mảnh)
...
GAUSSIAN_BLUR_KSIZE = 1     # [1,3,5,7] blur trước diff (1 = tắt)
...
class CVWorker(QThread):
    ...
    def _analyse(self, crop: np.ndarray, ref: np.ndarray,
        ...
        elif density < 15.0:  status = "LIGHT DUST"
        elif density < 25.0: status = "MODERATE"
